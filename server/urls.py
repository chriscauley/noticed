...
from location.views import location_list, location_detail, upload_notice, cached_google, location_from_place_id, delete_photo
...
urlpatterns = [
    ...
    re_path('^(?:login|logout|signup|reset-password|new|location)/', unrest_views.index),
